          ...
          return (
            ...
            >
              <input
                ...
                value={value}
                type="radio"
                className="appearance-none w-4.5 h-4.5 rounded-full border-2 border-border checked:border-accent checked:bg-accent checked:shadow-[inset_0_0_0_3px_white] cursor-pointer hover:border-accent transition-colors duration-200"
                {...register}
              />
              {label}
            </label>
