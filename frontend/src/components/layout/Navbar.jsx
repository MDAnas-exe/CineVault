      ...
      {isLoggedIn && (
        <div className="hidden md:flex gap-15 items-center">
          ...
          >
            ...
            <div
              className={twMerge(
                "  absolute right-0 top-full mt-3 w-60 rounded-2xl before:absolute before:-top-2 before:right-8 before:h-4 before:w-4 before:rotate-45 before:border-l before:border-t before:border-gray-200 before:bg-white before:content-[''] origin-top-right border border-gray-200 bg-white shadow-xl transition-all duration-200 ease-out",
                isOpen
