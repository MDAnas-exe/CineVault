...
const SearchBar = () => {
  ...
  return (
    <div className="bg-white  w-2/5 outline-1 outline-gray-300 rounded-xl p-2 relative hover:outline-accent focus-within:outline-accent transition-all duration-500 hidden md:flex items-center">
      <FaSearch
